...
#define RPI_FIRMWARE_STATE_ENABLE    (1U << 0)
#define RPI_FIRMWARE_STATE_NOT_EXIST (1U << 1)

/* Firmware IDs are the device-tree power-domain indices plus one. */
enum rpi_firmware_domain_id {
    RPI_FIRMWARE_I2C0_DOMAIN_ID = 1,
    RPI_FIRMWARE_I2C1_DOMAIN_ID,
    RPI_FIRMWARE_I2C2_DOMAIN_ID,
    RPI_FIRMWARE_VIDEO_SCALER_DOMAIN_ID,
    RPI_FIRMWARE_VPU1_DOMAIN_ID,
    RPI_FIRMWARE_HDMI_DOMAIN_ID,
    RPI_FIRMWARE_USB_DOMAIN_ID,
    RPI_FIRMWARE_VEC_DOMAIN_ID,
    RPI_FIRMWARE_JPEG_DOMAIN_ID,
    RPI_FIRMWARE_H264_DOMAIN_ID,
    RPI_FIRMWARE_V3D_DOMAIN_ID,
    RPI_FIRMWARE_ISP_DOMAIN_ID,
    RPI_FIRMWARE_UNICAM0_DOMAIN_ID,
    RPI_FIRMWARE_UNICAM1_DOMAIN_ID,
    RPI_FIRMWARE_CCP2RX_DOMAIN_ID,
    RPI_FIRMWARE_CSI2_DOMAIN_ID,
    RPI_FIRMWARE_CPI_DOMAIN_ID,
    RPI_FIRMWARE_DSI0_DOMAIN_ID,
    RPI_FIRMWARE_DSI1_DOMAIN_ID,
    RPI_FIRMWARE_TRANSPOSER_DOMAIN_ID,
    RPI_FIRMWARE_CCP2TX_DOMAIN_ID,
    RPI_FIRMWARE_CDP_DOMAIN_ID,
    RPI_FIRMWARE_ARM_DOMAIN_ID,
    RPI_FIRMWARE_NUM_DOMAIN_ID,
};
